...
import { WorkspaceDashboardPage as WorkspaceDashboardPageContent } from '@/features/workspace/pages';
...
export function WorkspaceDashboardPage({ params }: { params: { id: string } }) {
  ...
  return <WorkspaceDashboardPageContent workspace={workspace} />;
}
