import { WorkspaceTimeEntryPage } from '@/features/workspace/pages/workspace-time-entry-page';
...
export default function TimeEntryPage({ params }: { params: WorkspaceParams }) {
