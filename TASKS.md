...
- [x] **Реализовать систему иерархического роутинга**:
  - Единая конфигурация маршрутов в `router-config.ts`
  - Автоматическая генерация типов и навигационных функций
  - Поддержка sections/pages иерархии
  - Строгая типизация без использования `any`
  - Разделение ответственности через композицию хуков
  - Tracker UI концепция через workspace реализацию
  - Документация и архитектурное описание
